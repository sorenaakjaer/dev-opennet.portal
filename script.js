	...
	document.querySelectorAll(".Web_MainControl_textbox").forEach(function (t) {
		...
		computed: {
			...
			onpPendingOrdersSorted() {
				return this.onpPendingOrders.sort((e, t) => this.formatDateForJs(t.created_time) - this.formatDateForJs(e.created_time))
			},
			onpPendingOrdersSearched() {
				return this.onpPendingOrdersSorted
			},
			order() {
				if (this.theActiveOrderType === '001') {
					return this.OnpSSIDDetails.filter(e => e.v_count > 0)
				}
				if (this.theActiveOrderType === '002') {
					return this.theNewOrderSkaderItems
				}
				if (this.theActiveOrderType === '003') {
					const orderObj = {
						v_id: Date.now() + Math.random(),
						v_count: 1,
						TRANSACTION_CODE: '',
						LABEL: 'Uberettiget fejlretning',
						PRICE: 0,
						QUANTITY: 1,
						UNIT_LABEL: '',
						SSID: ''
		...
		methods: {
			...
			setFormItemValidated(formItem) {
				...
				if (formItem.id === 'FROM_COMPANY') {
					this.onpForm.forEach(onpFormItem => {
						if (onpFormItem.id !== 'FROM_COMPANY') {
				...
				if (formItem.id === 'TYPE') {
					this.onpForm.forEach(onpFormItem => {
						if (onpFormItem.id !== 'FROM_COMPANY' && onpFormItem.id !== 'TYPE') {
							onpFormItem.hide = true
							onpFormItem.value = ''
							onpFormItem.validated = true
						}
			...
			onCaseClicked(e, t) {
				run_autoupdate = !1;
				let s = this.cases.findIndex(t => t.onid == e.onid);
				s > -1 && (this.theOrignalActiveCase = this.cases[s]);
				var a = e.onid,
					i = e.onid_token;
				addMutationOberserverToSingleCase(), $(".js-modal__single-case .o-modal__body").hasClass("o-modal__body--loading") || $(".js-modal__single-case .o-modal__body").addClass("o-modal__body--loading"), $(".o-bg-overlay").addClass("o-bg-overlay--active"), $(".o-modal__case").addClass("o-modal--active"), $("body").css("overflow", "hidden");
				var r = $(".case_element[data-onid=" + a + "][data-onid_token=" + i + "]");
				$(r).clone().attr("id", "js-case-element__inserted").appendTo(".js-case-insert"), $(".o-modal__case").attr("data-case-id", a), $(".o-modal__case").attr("data-case-id-token", i), $(".ETRAY_READ_CASE_TOKEN_ID > input").val(i), $(".ETRAY_READ_CASE_ID > input").val(a), $(".ETRAY_READ_MESSAGE_TYPE > input").val("VIEW_CASE"), $(".ETRAY_VIEW_CASE > a").click(), subCatChangeSelect("List of Cases"), "ON" == this.theUserType && (0 > e.to_company.concat(e.from_company).indexOf("OpenNet") ? ($(".js-o-modal__case__actions").hasClass("hidden_field") || $(".js-o-modal__case__actions").addClass("hidden_field"), $(".js-o-modal__case__commentary").hasClass("hidden_field") || $(".js-o-modal__case__commentary").addClass("hidden_field")) : ($(".js-o-modal__case__actions").removeClass("hidden_field"), $(".js-o-modal__case__commentary").removeClass("hidden_field")));
				var o = a + " - " + e.filter_inquiry_type;
				$(".js-modal__single-case__title").text(o), readEtrayCase(i, a), $(document).one("etray::single-case-loaded", function () {
			...
			searchFunc(e) {
				...
				for (var a = [], i = function e(t) {
					for (var s = 0, a = t.length - 1; s < t.length && " " == t[s];) s++;
					for (; a > s && " " == t[a];) a -= 1;
					return t.substring(s, a + 1)
				}(this.searchQuery.toLowerCase()), r = 0; r < e.length; r++)
					for (var o in e[r]) {
						var l = e[r][o];
						("string" == typeof l || l instanceof String) && (l = l.toLowerCase()), ("number" == typeof l || l instanceof Number) && (l = l.toString()), -1 == l.indexOf(i) || s(a, e[r]) || a.push(e[r])
					}
				return a
			},
			setTheActiveUser(e) {
			...
			setOpenCases() {
				var e = $(".ETRAY_JSON_LIST_OF_OPEN_CASES > div").html();
				$(".js-o-cases__container").removeClass("o-cases__container--loading"), $(".o-page").removeClass("o-page--is-loading"), !(e.length < 3) && (this.encodeCases(e), $(".ETRAY_JSON_LIST_OF_OPEN_CASES > div").html(""))
			},
			readOpenCasesV2(e, t) {
			...
			funcObserveOpenCasesV2() {
				var e = this;
				e.observeOpenCasesV2 = new MutationObserver(function (t) {
					e.observeOpenCasesV2.disconnect();
					var s = $(".ETRAY_JSON_LIST_OF_OPEN_CASES_V2 > div").html(),
						a = 0;
					s.length > 3 && (a = JSON.parse(s).length + 1, e.encodeCases(s)), a >= e.open_addLength ? (e.open_startLength = e.open_endLength + 1, e.open_endLength = e.open_endLength + e.open_addLength, e.readOpenCasesV2(e.open_startLength, e.open_endLength)) : (e.casesIsLoading = !1, $(".ETRAY_JSON_LIST_OF_OPEN_CASES_V2 > div").html(""), e.readClosedCases(e.startLength, e.endLength), $(".js-o-cases__container").removeClass("o-cases__container--loading"), $(".o-page").removeClass("o-page--is-loading"))
				}), e.observeOpenCasesV2.observe(document.querySelector(".ETRAY_JSON_LIST_OF_OPEN_CASES_V2 > div"), {
					characterData: !0,
					childList: !0
				})
			},
			readClosedCases(e, t) {
				$(".ETRAY_JSON_LIST_OF_CLOSED_CASES_ROW_START > input").val(e), $(".ETRAY_JSON_LIST_OF_CLOSED_CASES_ROW_END > input").val(t), this.observeClosedCases && this.observeClosedCases.disconnect(), $(".ETRAY_JSON_LIST_OF_CLOSED_CASES > div").html(""), this.funcObserveClosedCases(), $(".BTN_GetListOfClosedCasesJSON > a").click()
			},
			funcObserveClosedCases() {
				var e = this;
				e.observeClosedCases = new MutationObserver(function (t) {
					e.observeClosedCases.disconnect();
					var s = $(".ETRAY_JSON_LIST_OF_CLOSED_CASES > div").html(),
						a = 0;
					s.length > 3 && (a = JSON.parse(s).length + 1, e.pushClosedCases()), a >= e.addLength ? (e.startLength = e.endLength + 1, e.endLength = e.endLength + e.addLength, e.readClosedCases(e.startLength, e.endLength)) : (e.isClosedCasesLoading = !1, run_autoupdate = !0, $(".ETRAY_JSON_LIST_OF_CLOSED_CASES > div").html(""))
				}), e.observeClosedCases.observe(document.querySelector(".ETRAY_JSON_LIST_OF_CLOSED_CASES > div"), {
					characterData: !0,
					childList: !0
				})
			},
			pushClosedCases() {
				var e = $(".ETRAY_JSON_LIST_OF_CLOSED_CASES > div").html();
				this.encodeCases(e)
			},
			encodeCases(e) {
				!(e.length < 3) && JSON.parse(e).forEach((e, t) => {
					(Object.keys(e).forEach(function (t, s) {
						e[t] = unescape(e[t])
					}), this.theUser) ? (e.created_by_id && e.created_by_id == this.theUser.id && (Vue.set(e, "filter_created_by_me", "true"), Vue.set(e, "filter_my_cases", "true")), e.assign_to_id && e.assign_to_id == this.theUser.id && (Vue.set(e, "filter_assigned_me", "true"), Vue.set(e, "filter_my_cases", "true")), e.followed_by_list && e.followed_by_list.split(";").indexOf(this.theUser.id) > -1 && (Vue.set(e, "filter_followed_by_me", "true"), Vue.set(e, "filter_my_cases", "true"))) : this.isEncodedHappenedBeforeUser = !0;
					var s = this.cases.findIndex(t => t.onid == e.onid);
					s < 0 ? this.cases.push(e) : Vue.set(this.cases, s, e)
				})
			},
			readNewCase() {
			...
			funcObserveDocsClosed() {
				...
				let e = this;
				var t = new MutationObserver(function (s) {
					var a = document.querySelector(".ETRAY_EXT_DOCS_RAW_JSON_CLOSED > div").innerHTML;
					e.setDocs(a), e.isClosedDocsLoading = !1, t.disconnect()
				});
				t.observe(document.querySelector(".ETRAY_EXT_DOCS_RAW_JSON_CLOSED > div"), {
					characterData: !0,
					childList: !0
				})
			},
			setDocs(e) {
				e.length > 2 && JSON.parse(e).forEach((e, t) => {
					0 > this.items.findIndex(t => t.onid == e.onid) && this.items.push(e)
				})
			},
			setSearchInOldCases() {
			...
			setTheEditOnp(e) {
				this.onpForm.forEach((t, s) => {
					t.value = e[t.id]
				}), this.setIsCreateOnpModal()
			},
			...
			setEncodeDataPendingOrders(e, t) {
				...
				console.log("str", e), e.length > 2 && JSON.parse(s(s(e))).forEach(e => {
			...
			infinteScrollONPOrdersLoadMore() {
				if ("end_customer_orders" === this.activeCategory) {
					if (this.onpPendingOrdersFiltered.length < 50) {
						this.infiniteScrollNumberONPOrders = 50;
						return
					} !(this.infiniteScrollNumberONPOrders > this.onpPendingOrdersFiltered.length) && (this.infiniteScrollNumberONPOrders += 50)
				}
			},
						...
						if (str.length > 4) {
							...
							if (isJsonString(str)) {
								...
								formData.forEach(formInput => {
									...
									if (idx > -1) {
										this.theEndCustomerEmailConfigForm[idx].value = formInput.value
									}
								})
							}
...
function openBurgerMenu() {
	$(".o-page").hasClass("o-page--menu-open") || $(".o-page").addClass("o-page--menu-open"), $(".js-menu-toggle").hasClass("active") || $(".js-menu-toggle").addClass("active"), $(".o-menu__items").hasClass("o-menu__items--active") || $(".o-menu__items").addClass("o-menu__items--active"), $(".o-menu__overlay").hasClass("o-menu__overlay--active") || $(".o-menu__overlay").addClass("o-menu__overlay--active")
}
...
mediaQuery.matches && openBurgerMenu(), $(document).on("trigger::vue_mounted", function () {
	$("#webform").appendTo(".js-form-create-case"), addEtrayCreateFormEventListeners(), $(".js-menu-toggle").off("click"), $(".js-menu-toggle").on("click", function () {
		$(this).hasClass("active") ? closeBurgerMenu() : openBurgerMenu()
	}), $(".js-btn-create-case").off("click"), $(".js-btn-create-case").on("click", function () {
		run_autoupdate = !1, window.scroll(0, 0), subCatChangeSelect("Create Case"), window.matchMedia("(max-width: 600px)").matches && closeBurgerMenu(), $(this).hasClass("active") ? closeCreateCase() : ($(this).addClass("active"), $(".o-bg-overlay").addClass("o-bg-overlay--active"), $(".js-o-modal__create-case").addClass("o-create-case--active"), $("body").css("overflow", "hidden"), $(".js-modal-create-title").text("Opret sag"))
	}), $(".js-o-menu__overlay").off("click"), $(".js-o-menu__overlay").on("click", function () {
		$(".js-menu-toggle").removeClass("active"), $(".o-menu__items").removeClass("o-menu__items--active"), $(".o-menu__overlay").removeClass("o-menu__overlay--active")
	}), $(".js-click-nav__home").off("click"), $(".js-click-nav__home").on("click", function () {
		$(".o-page").removeClass("o-page--docs"), $(".o-page").removeClass("o-page--all-cases"), $(".o-menu__items__inner li").each(function () {
			$(this).removeClass("li--active")
		}), $(this).addClass("li--active"), $(".js-page-title").text("Hjem / Mine sager"), $(".ETRAY_LIST_VIEWER_CASES_LEVEL_1 > input").val(""), $(".ETRAY_LIST_VIEWER_CASES_LEVEL_2 > input").val(""), $(".js-filter-level2__new_announcements").css("display", ""), showSpecificLevel3Filters([".js-filter__sla", ".js-filter__created_by_me", ".js-filter__assigned_to_me", ".js-filter__follows"]), resetLevel2FiltersToInitialState(), window.matchMedia("(max-width: 600px)").matches && closeBurgerMenu(), window.scroll(0, 0)
	}), $(".js-click-nav__all-cases").off("click"), $(".js-click-nav__all-cases").on("click", function () {
		$(".o-page").removeClass("o-page--docs"), $(".o-page").hasClass("o-page--all-cases") || $(".o-page").addClass("o-page--all-cases"), $(".o-menu__items__inner li").each(function () {
			$(this).removeClass("li--active")
		}), $(this).addClass("li--active"), $(".js-page-title").text("Alle sager"), $(".ETRAY_LIST_VIEWER_CASES_LEVEL_1 > input").val("all"), $(".js-filter-level2__new_announcements").css("display", "none"), showSpecificLevel3Filters([".js-filter__sla", ".js-filter__new", ".js-filter__not_assigned", ".js-filter__follow-up", ".js-filter__assigned_to"]), resetLevel2FiltersToInitialState(), window.matchMedia("(max-width: 600px)").matches && closeBurgerMenu(), window.scroll(0, 0)
	})
}), $(".js-close-o-create-case").on("click", function () {
	closeCreateCase()
}), $(".js-click-on-overlay").on("click", function () {
	closeCreateCase(), closeCasesModal()
...
updateProgress(), $(window).on("scroll", updateProgress);
var offset = 250,
	duration = 550;
...
function closeCasesModal() {
	run_autoupdate = !0, $(".o-bg-overlay").removeClass("o-bg-overlay--active"), $(".o-modal__case").removeClass("o-modal--active"), $("#js-case-element__inserted").remove(), $("body").css("overflow", ""), $(".js-modal__single-case .o-modal__body").hasClass("o-modal__body--loading") || $(".js-modal__single-case .o-modal__body").addClass("o-modal__body--loading"), $(document).trigger("vue::close_cases_modal")
}
...
readAllNotifications(), readAllNumberOfCases(), $(".js-close-modal").on("click", function () {
	closeCasesModal()
	...
	var e = $(".comment_field").val();
	$(".ETRAY_READ_CASE__COMMENT_TEXTAREA > textarea").val(e), $(".ETRAY_READ_MESSAGE_TYPE > input").val($(".ETRAY_COMMENT_MESSAGE_TYPE > input").val());
	var t = $(".o-modal__case").attr("data-case-id-token"),
		s = $(".o-modal__case").attr("data-case-id");
	$(".ETRAY_READ_CASE_TOKEN_ID > input").val(t), $(".ETRAY_READ_CASE_ID > input").val(s), !0 == submit_validation_logic() && (clearJSONfields(), $(".webformCreateMore").click(), addMutationOberserverToSingleCase(), clear_fields_after_submit(), readEtrayCase(t, s)), $(".js-case__save-commentary").hasClass("o-btn--loading") || $(".js-case__save-commentary").addClass("o-btn--loading"), $(document).one("etray::single-case-loaded", function () {
		$(".o-modal__case__commentary__textarea").val(""), $(".js-case__save-commentary").removeClass("o-btn--loading")
	}), "Afsluttet" == $("#js-case-element__inserted > div > .etray_case_status span").html() && ($("#js-case-element__inserted > div > .etray_case_status").html('<span class="o-pill o-pill--yellow">\xc5ben</span>'), $(".js-case__save-commentary").html("Gem kommentar"), $(".js-case-save-close").hasClass("display_none") && $(".js-case-save-close").removeClass("display_none"), $(".js-case-save-reopen").hasClass("display_none") || $(".js-case-save-reopen").addClass("display_none"), $(document).trigger("vue::update_case_prop", [s, {
...
$("body").on("drag dragstart dragend dragover dragenter dragleave drop", function (e) {
	...
	(droppedFiles = e.originalEvent.dataTransfer.files) && handleFiles(droppedFiles)
	...
	$(".js-filter__assigned_to .js-o-dropdown__ul").append('<li id="">Alle brugere</li>'), $(".v_list_of_cases > p").each(function () {
		let e = $(this).attr("id"),
			t = $(this).text();
		$(".js-filter__assigned_to .js-o-dropdown__ul").append('<li id="' + e + '">' + t + "</li>")
	}), $(".js-filter__assigned_to.js-o-dropdown ul li").on("click", function () {
		var e = $(".ETRAY_LIST_VIEWER_CASES_LEVEL_5 > input").val(),
			t = $(this).attr("id"),
			s = $(this).closest(".js-o-dropdown").find(".o-dropdown__selected p").attr("id"),
			a = "";
		if ($(this).closest(".js-o-dropdown").find(".o-dropdown__selected p").text($(this).text()), $(this).closest(".js-o-dropdown").find(".o-dropdown__selected p").attr("id", t), a = e.replace(s, t), $(".ETRAY_LIST_VIEWER_CASES_LEVEL_5 > input").val(a), t.length > 0) {
			if (!$(this).closest(".js-o-dropdown").hasClass("o-dropdown--has-selection")) {
				$(this).closest(".js-o-dropdown").addClass("o-dropdown--has-selection");
				var i = $(".js-filter__not_assigned");
				if (i.hasClass("o-btn__filter---active")) {
					i.removeClass("o-btn__filter---active");
					var r = $(".ETRAY_LIST_VIEWER_CASES_LEVEL_3 > input").val();
					r = r.replace(i.data("filter"), ""), $(".ETRAY_LIST_VIEWER_CASES_LEVEL_3 > input").val(r)
				}
			}
		} else $(this).closest(".js-o-dropdown").removeClass("o-dropdown--has-selection")
	}), $(this).hasClass("o-dropdown--active") ? closeDropdown() : $(this).addClass("o-dropdown--active"), $(".o-page").on("click", function (e) {
		!$(e.target).closest(".js-o-dropdown").hasClass("o-dropdown--active") && closeDropdown()
	})
	...
	}).prop("selected", !0), $(".js-filter__open-cases").click(), $(".v_list_of_cases").html($(".ETRAY_LIST_OF_USERS > div").html()), clearJSONfields(), $(".UM_COPY_OF > select").html('<option value="">[V\xe6lg]</option>' + $(".v_list_of_cases").html().replaceAll("</p>", "</option>").replaceAll("<p id", "<option value")), "true" == $(".show_announcement_menu").html() || $(".menu_announcement").addClass("hidden_field"), "true" == $(".show_contract_menu").html() || $(".menu_contract").addClass("hidden_field"), "true" == $(".show_documentation_menu").html() || $(".menu_documentaion").addClass("hidden_field"), "true" == $(".show_invoice_menu").html() || $(".menu_invoice").addClass("hidden_field"), "true" == $(".show_report_menu").html() || $(".menu_report").addClass("hidden_field"), "true" == $(".show_user_admin_menu").html() || $(".menu_user_admin").addClass("hidden_field"), $.getScript("https://cdn.jsdelivr.net/npm/vue@2", function (e, t, s) {
